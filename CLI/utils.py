...
def github(name):
    ...
    Payload = '{ "name":"My-ResuME-Website-'+name.replace(" ","-")+'", "description":"This repo is auto generated by ResuME" }'
    Headers = {
    ...
    # push_to_github("My-ResuME-Website","data.json",'"{"message":"dummy json data"}"')

# def push_to_github(repo, path, data):
#     PAT = getENV("PAT")
#     API_URL = 'https://api.github.com'
#     Owner = getENV("owner")
